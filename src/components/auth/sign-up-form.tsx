    ...
    return (
      <div className="space-y-6 text-center">
        <div
          ...
          aria-hidden
        >
          <CheckCircle2 className="size-7 text-success" strokeWidth={1.75} />
        </div>
  ...
  return (
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-body text-text-tertiary">
          Free forever for the first 100 sets. No card required.
        </p>
      </header>
      ...
      <form onSubmit={handleSignUp} className="space-y-5">
        ...
        <p className="text-micro text-text-quaternary">
          ...
          <Link
            href="/terms"
            className="text-text-tertiary underline-offset-4 hover:text-text-secondary hover:underline"
          >
            Terms
          </Link>{" "}
          and{" "}
